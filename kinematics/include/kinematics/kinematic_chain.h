...
{
    class kinematic_chain : public i_kinematic_chain
    {
    public:
        ...
        void set_state(double u1_rad, double u2_rad, double r1_rad, double r2_rad, double p1_meters) override
        {
        ...
        virtual int get_nb_joints() const override
        {
            return 5;
        }
