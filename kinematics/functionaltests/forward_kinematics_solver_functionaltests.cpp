...
namespace kinematics
{
    ...
    struct GIVEN_kinematic_chain : public ::testing::Test
    {
    protected:
        ...
        GIVEN_kinematic_chain() : _chain(_chain_factory.create()), _fk_solver() {}
    };

    struct GIVEN_case_1 : public GIVEN_kinematic_chain
    {
    protected:
        const point _expected_point = point(0.8, 0.0, 0.3);
    };

    TEST_F(GIVEN_case_1, WHEN_compute_end_effector_position_THEN_return_expected_point)
    {
        EXPECT_EQ(_expected_point, _fk_solver.compute_end_effector_position(_chain));
    }

    struct GIVEN_case_2 : public GIVEN_kinematic_chain
    {
    protected:
    ...
    TEST_F(GIVEN_case_2, WHEN_compute_end_effector_position_THEN_return_expected_point)
    {
    ...
    struct GIVEN_case_3 : public GIVEN_kinematic_chain
    {
    protected:
    ...
    TEST_F(GIVEN_case_3, WHEN_compute_end_effector_position_THEN_return_expected_point)
    {
        const point result = _fk_solver.compute_end_effector_position(_chain);
    ...
    struct GIVEN_case_4 : public GIVEN_kinematic_chain
    {
    protected:
    ...
    TEST_F(GIVEN_case_4, WHEN_compute_end_effector_position_THEN_return_expected_point)
    {
        const point result = _fk_solver.compute_end_effector_position(_chain);
    ...
    struct GIVEN_case_5 : public GIVEN_kinematic_chain
    {
    protected:
    ...
    TEST_F(GIVEN_case_5, WHEN_compute_end_effector_position_THEN_return_expected_point)
    {
        const point result = _fk_solver.compute_end_effector_position(_chain);
